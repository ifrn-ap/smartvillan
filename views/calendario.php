<div class="text-center"><h4><span id="mes"></span></h4><hr></div>
<div class="row">
	<div class="col-md-12">
	...
	<div class="col-md-3" style="background: #222; color: white;">
		<div class="text-center">
			<h4>Dia Atual</h4>
		</div>
	</div>
	<div class="col-md-3" style="background: red; color: white;">
		<div class="text-center">
			<h4>Ordenhas</h4>
		</div>
	</div>
	<div class="col-md-3" style="background: yellow; color: black;">
		<div class="text-center">
			<h4>Vacinações</h4>
		</div>
	</div>
	<div class="col-md-3" style="background: blue; color: white;">
		<div class="text-center">
			<h4>Ambos</h4>
		</div>
	</div>
