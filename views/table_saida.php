<div class="row">
    <div class="col-md-12">
        <h3 class="text-center">Saidas Realizadas</h3><hr>
    </div>
</div>
			            ...
			            while($row = $_POST['saida']->fetch_assoc()){
			                ...
			                echo'
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="text-center">
                                                    <a class="btn btn-primary" href="views.php?&acao=deletar-saida&id='.$row['idsaida'].'">Sim</a>
			                    ...
			                    <tr>
			                        ...
			                        <td>
                                        <center>
                                            <a href="views.php?acao=atualizar-saida&id='.$row['idsaida'].'">
